...
Hello! I am a PhD student at the [Institute de Mathématiques d'Orsay](https://www.imo.universite-paris-saclay.fr/fr/) ([Université Paris-Saclay](https://www.universite-paris-saclay.fr/)) under the supervision of [Frédéric Rousset](https://www.imo.universite-paris-saclay.fr/~frederic.rousset/).

I completed a master's degree in Mathematics and Applications (M2 Analysis, Modelisation, and Simulation) at Université Paris-Saclay. Previously, I studied at the Universidad de Chile, obtaining a master's degree in applied mathematics from the Departamento de Ingeniería Matemática (DIM UCH) under the advice of Claudio Muñoz.
